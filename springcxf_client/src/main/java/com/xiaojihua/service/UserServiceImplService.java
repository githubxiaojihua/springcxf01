 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://service.xiaojihua.com/", wsdlLocation = "http://localhost:8080/springcxfserver/ws/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://service.xiaojihua.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/springcxfserver/ws/user?wsdl");
    ...
    public IUserService getUserServiceImplPort() {
        return super.getPort(new QName("http://service.xiaojihua.com/", "UserServiceImplPort"), IUserService.class);
    }
    ...
    public IUserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.xiaojihua.com/", "UserServiceImplPort"), IUserService.class, features);
    }
