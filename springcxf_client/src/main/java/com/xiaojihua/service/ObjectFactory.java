 ...
 * generated in the com.xiaojihua.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHiResponse_QNAME = new QName("http://service.xiaojihua.com/", "sayHiResponse");
    private final static QName _FindCarsByUser_QNAME = new QName("http://service.xiaojihua.com/", "findCarsByUser");
    private final static QName _FindCarsByUserResponse_QNAME = new QName("http://service.xiaojihua.com/", "findCarsByUserResponse");
    private final static QName _SayHi_QNAME = new QName("http://service.xiaojihua.com/", "sayHi");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xiaojihua.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xiaojihua.com/", name = "sayHiResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xiaojihua.com/", name = "findCarsByUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xiaojihua.com/", name = "findCarsByUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xiaojihua.com/", name = "sayHi")
